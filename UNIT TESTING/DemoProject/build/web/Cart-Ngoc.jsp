                ...
                <div class="cart-view">
                    <table class="cart-view-table">
                        ...
                        <tr>
                            ...
                            <td class="quantity">
                                <div class="quantity">
                                    <input id="quantityInput" type="text" value="<%= c.getQuantity() %>">
                                    <button class="decrement" onclick="decrementValue()">-</button>
                                    <button class="increment" onclick="incrementValue()">+</button>
                                </div>
                            </td>
                        ...
                        <td class="price" id="price"><fmt:formatNumber type="currency" value="<%= c.getPrice() %>" currencyCode="VND" maxFractionDigits="0" /></td>
                        <%
                        float totalPrice = 0;
                        totalPrice = c.getQuantity() * c.getPrice();
                        %>
                        <td class="total-price" id="total"><fmt:formatNumber type="currency" value="<%= totalPrice %>" currencyCode="VND" maxFractionDigits="0" /></td>
                        <td class="action"><button>Delete</button></td>
                        </tr>
                        <%
                        }
                        %>
                        <<script >
                           var quantityElement = var quantity = document.getElementById("quantityInput").value;
                            var quantity = parseInt(quantityElement);
                            var priceInt = parseInt(priceString, 10);
