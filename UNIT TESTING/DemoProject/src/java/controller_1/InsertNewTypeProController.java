...
//            String modby = acc.getAcname();
            ...
            String savePath = "C:\\Users\\win\\Downloads\\DemoProject\\DemoProject\\web\\images"; // Giả sử có một thư mục images trên server
            ...
            String user = "sa";
            String pass = "sa";
            String url = "jdbc:sqlserver://localhost:1433;databaseName=ProjectGroupp5";
            try {
                ...
                int row1 = ptd.insert(producttype, conn);
                int row2 = pd.insert(p, conn);
                // Commit giao dịch
                conn.commit();
