...
//10
    String convertDecToOther(String valueInput, int baseOutput) {
...
//2
    String convertBinToOther(String valueInput, int baseOutput) {
        BigInteger numberIn = new BigInteger(valueInput);
...
//16
    String convertHexToOther(String valueInput, int baseOutput) {
